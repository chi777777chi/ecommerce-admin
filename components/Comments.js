...
export default function Comments({ productId }) {
    ...
    const addComment = async () => {
        ...
        // const newComment = {
        //     product: { "productId": 1 }, // Use the productId prop
        //     member: { "memberId": 1231 }, // Replace with the actual member ID
        //     order: { "orderId": 123 }, // Replace with the actual order ID
        //     ratingScore: rating,
        ...
        //     setComments([...comments, savedComment]); // Update local state
        //     setAuthor('');
        //     setText('');
        //     setRating(0);
        // }
